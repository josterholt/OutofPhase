...
OPGame.WesternKingdom.prototype = {
    preload: function () {
        ...
        // Scene assets
        game.load.image('outdoors1', 'images/scene/B-E_HF1R_Outdoors_2.png');
        ...
        game.load.spritesheet('player1', 'images/characters/11sprite.png', 32, 48);
        game.load.spritesheet('player2', 'images/characters/xmasgirl1.png', 32, 48);
    ...
    create: function () {
        ...
        map.addTilesetImage('GermaniaA2', 'GermaniaA2');
        map.addTilesetImage('B-E_HF1R_Outdoors_2', 'outdoors1');
        map.addTilesetImage('B-E_HF1R_Dungeon_1', 'Dungeon');
